import time
import random
from multiprocessing import Process, Condition, Manager, Queue
from tkinter import *

# Inicializamos las variables globales que se utilizarán en el programa 
k = 10
lec_espera = 0
es_espera = 0
...
def esc(id, condition, lista, es_espera, lec_espera, queue):
    for v in range(k):
        ...
        print('Escritor piensa en lo que va a escribir', v)
        condition.acquire()
...
def lec(id, condition, lista, es_espera, lec_espera, queue):
    for v in range(k):
        ...
        print("Lector reflexiona sobre lo leído", v)
...
if __name__ == "__main__":
    ...
    etiqueta1 = Label(frame, text="Número de iteraciones")
